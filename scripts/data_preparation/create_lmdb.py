...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    # folder_path = '/home/ubuntu/all_data/DF2K_train_HR_subX3'
    # lmdb_path = '/home/ubuntu/all_data/DF2K_sub/HR/DF2K_train_HR_subX3.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    folder_path = '/home/ubuntu/all_data/DF2K_sub/DF2K_train_LR_X2_sub3'
    lmdb_path = '/home/ubuntu/all_data/DF2K_sub/LR_X2/DF2K_train_LR_X2_sub3.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    folder_path = '/home/ubuntu/all_data/DF2K_sub/DF2K_train_LR_X3_sub3'
    lmdb_path = '/home/ubuntu/all_data/DF2K_sub/LR_X3/DF2K_train_LR_X3_sub3.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # # LRx4 images
    # folder_path = '/home/ubuntu/all_data/DIV2K_384/DIV2K_train_LR_sub'
    # lmdb_path = '/home/ubuntu/Project/HADN-main/datasets/DIV2K_train_LR_X4_sub384.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
