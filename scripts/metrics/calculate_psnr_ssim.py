...
def main(args):
    ...
    for i, img_path in enumerate(img_list_gt):
        ...
        print(f'{i+1:3d}: {basename:26}. \tPSNR: {psnr:.6f} dB, \tSSIM: {ssim:.6f}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/home/ubuntu/Project/HADN-main/results/metrics/hr_crop', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/home/ubuntu/Project/HADN-main/results/metrics/sr_crop/EFDN', help='Path to restored images')
